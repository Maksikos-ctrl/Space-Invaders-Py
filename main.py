import pygame
import random
from constants import RED_player, GREEN_player, BLUE_player, player, RED_LASER, GREEN_LASER, BLUE_LASER, YELLOW_LASER, bg, bg_menu, WIDTH, HEIGHT, WINDOW
...
def main():
    ...
    enemies = []
    wave_length = 5
    button = pygame.Rect(300, 650, 200, 50)
...
def start_menu():
    ...
    while running:
        ...
        # play_button = pygame.transform.rotate(play_button, 90)
